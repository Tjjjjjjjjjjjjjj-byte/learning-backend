    ...
    <>
      {!minimized ? (
        <div className="playlistCreateDiv">
          <button className="createPlaylist-btn" onClick={() => setHidden(!hidden)}>
      ...
      <div className={hidden ? "createOptions hidden" : "createOptions"}>
        ...
        >
          <ReactSVG src={hoveredButton === "playlist" ? "/spotify-playlist-hovered.svg" : "/spotify-playlist.svg"} />
        ...
        <button 
          ...
          onMouseLeave={handleMouseLeave}
        >
          <ReactSVG src={hoveredButton === "blend" ? "/spotify-blend-hovering.svg" : "/spotify-blend.svg"} />
        ...
        <button 
          ...
          onMouseLeave={handleMouseLeave}
        >
          <ReactSVG src={hoveredButton === "folder" ? "/spotify-folder-hovered.svg" : "/spotify-folder.svg"} />
